...
.info-blocks {
  padding: 20px 0px;
   ...
   <div class="row" style="margin-top: 5px;">
         <div class="col-md-12  ">
              <div class="page-header "><h1>Welcome to Tagaytay Country Hotel</h1></div>
               <div class="stretch col-md-6">
                  <a href="portfolio-item.html">
                    <img class="img-responsive img-rounded" src="<?php echo WEB_ROOT; ?>images/background-images.jpg" alt="">
                </a>
               </div> 
                <h3>
                    <a href="portfolio-item.html">Tagaytay Country Hotel</a>
                </h3>
                <p>Welcome, To Tagaytay Country Hotel we serve the best booking for you!</p>
           </div> 
      ...
      <div class="row" style="padding: 10px 0px;">
        ...
        <div class="row" >
            <div class="col-md-12 img-portfolio">
             <div class="page-header"><h1>Accomodations</h1></div> 
                <div id="carousel-example-generic" class="carousel slide" data-ride="carousel"> 
                    <div class="carousel-inner">
                     <div id="itemacom" class="item active">
                     <img    src="<?php echo WEB_ROOT; ?>tch-img/bgd.jpg">
