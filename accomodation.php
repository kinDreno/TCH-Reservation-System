...
// filtering the rooms
 // ======================================================================================================
                      $sqlQuery ="SELECT * FROM `tblreservation`     WHERE ((
             ...
             if($status=='Confirmed'){
                 $btn =  '<div class="form-group">
                        <div class="row">
                          <div class="col-xs-12 col-sm-12">
                             <div style=" color: rgba(0,0,0,1); font-size:15px;"><strong>Fully Reserved!</strong></div>
                ...
                $btn =  '<div class="form-group">
                        <div class="row">
                          <div class="col-xs-12 col-sm-12">
                             <div style=" color: rgba(0,0,0,1); font-size:15px;"><strong>Fully Book!</strong></div>
                ...
                ?>
                 ...
                 <input type="hidden" name="ROOMPRICE" value="<?php echo $result->PRICE ;?>">
                  ...
                  <div id="roomimg" class="col-md-4 img-portfolio">
                    ...
                    <a href="#" >
                        <figure id="galleryitem" class="gallery-item ">
